...
`${API_BASE}/users/${user.id}/orders-permissions`,
        {
          method: "PUT",
          headers: {
      ...
      <div className="border border-slate-200 rounded-xl overflow-hidden">
        ...
        {[
          ...
          { key: "partyName", label: "Party Name" },
            { key: "type", label: "Type" },          // ✅ ADD
  { key: "dueDate", label: "Due Date" },   // ✅ ADD
...
<button
  ...
  style={{
    ...
    height: "24px",
    backgroundColor:
      !!local.columns[row.key] ? "#059669" : "#e5e7eb",
    borderRadius: "999px",
    position: "relative",
...
>
  <span
    style={{
      position: "absolute",
      top: "2px",
      left: !!local.columns[row.key] ? "22px" : "2px",
      width: "18px",
      height: "18px",
